                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px">
                                            ...
                                            <tr>
                                                <td style="text-align: center;">
                                                    <h1 style="font-size: 28px;line-height: 110%;margin-bottom: 20px;margin-top: 0;padding: 0;"><div style="text-align: center;"> Verification Code</div>
                                                    </h1>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    ">
                                                        <div>
                                                            <span class="card-discount" style="font-size: 16px;">Your Email Verification Code is : {{ $data['code'] }}</span><br>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
