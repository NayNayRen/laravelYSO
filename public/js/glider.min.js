...
!(function (e) {
    ...
    return (
        (t.init = function (e, t) {
            ...
            (t = t || l),
                ("auto" !== i.opt.slidesToShow &&
                    void 0 === i.opt._autoSlide) ||
                ...
                [].forEach.call(n.slides, function (e, t) {
                    var o = e.classList,
                        ...
                        s =
                            ...
                            Math.ceil(s) >= Math.floor(i) &&
                                Math.floor(l) <= Math.ceil(r));
                    o.toggle("visible", s),
                        s !== e &&
        ...
        (t.scrollItem = function (e, t, o) {
            ...
            var i,
                ...
                l =
                    !0 === t
                        ? (e = Math.round(
                              (e * r.containerWidth) / r.itemWidth
                          )) * r.itemWidth
                        : ("string" == typeof e &&
                              ((l = "prev" === e),
                              (e =
                                  r.opt.slidesToScroll % 1 ||
                                  r.opt.slidesToShow % 1
                                      ? r.getCurrentSlide()
                                      : r.slide),
                              l
                                  ? (e -= r.opt.slidesToScroll)
                                  : (e += r.opt.slidesToScroll),
                              r.opt.rewind &&
                                  ((i = r.ele.scrollLeft),
                                  (e =
